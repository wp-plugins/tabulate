...
class Menus {
	...
	public function enqueue( $page ) {
		...
		$timepicker_url = plugins_url( TABULATE_SLUG ) . '/components/jquery-timepicker-addon/jquery-timepicker-addon-built.js';
		...
		// Add stylesheets.
		$timepicker_url = plugins_url( TABULATE_SLUG ) . '/components/jquery-timepicker-addon/jquery-timepicker-addon-built.css';
